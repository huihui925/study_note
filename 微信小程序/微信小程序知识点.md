...
必须使用企业账号角色 个人账号没有此权限, 

![image-20200317160205680](微信小程序知识点.assets/image-20200317160205680.png)



**因为我是个人账户,所以无法演示支付功能,这里会根据视频做讲解:**

想要实现微信支付也是需要有自己的后台服务器的.

完整(后端+前端)的微信支付比较繁琐,但我们是纯前端,只需了解前端即可, 根据后端给的接口文档流程来进行操作就足够了
...
![image-20200317195001870](微信小程序知识点.assets/image-20200317195001870.png)

### 18.2 业务逻辑 

![image-20200317195152151](微信小程序知识点.assets/image-20200317195152151.png)
